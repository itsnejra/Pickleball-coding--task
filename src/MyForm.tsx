...
const App: React.FC = () => {
  ...
  <div className="innerWrapper">
    ...
    <div className="image"><img src="https://static.thenounproject.com/png/2392586-200.png" alt="Location Icon" className="icon"></img></div>
          ...
          <form key={index} onSubmit={(e) => handleSubmit(e, index)}>
            ...
            <div>
              ...
              <input
                ...
                className={errors[index].venueTitle ? "error" : ""}
              />
    ...
    <span className="error-message">Venue Title is required</span>
            ...
            <div className="address-container">
              <div className="adress-container">
                ...
                <input
                  className={`adressInput ${errors[index].address ? "error" : ""}`}
                  type="text"
                  id={`address-${index}`}
                  name="address"
              ...
              <div className="city-container">
                ...
                <input
                  className={`cityInput ${errors[index].city ? "error" : ""}`}
                  type="text"
                  id={`city-${index}`}
                  name="city"
                  value={formData.city}
            ...
            <div className="state-container">
              <div className="inner-state-container">
                <label htmlFor={`state-${index}`}>State:</label>
                <select
                  className={`stateInput ${errors[index].state ? "error" : ""}`}
                  id={`state-${index}`}
                  name="state"
                ...
                {errors[index].state && <span className="error-message-state">State is required</span>}
                </div>
              <div>
                <label htmlFor={`zip-${index}`}>ZIP:</label>
                <input
                  type="text"
                  className={`zipInput ${errors[index].zip ? "error" : ""}`}
                  id={`zip-${index}`}
                  name="zip"
                  value={formData.zip}
                  onChange={(e) => handleInputChange(index, e)}
            ...
            <hr />
            <div className="parkingFeeWrapper">
            <Switch
